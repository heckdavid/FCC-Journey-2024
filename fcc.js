...
// Reminder to change the code to a different kind of loop. //
for (let i = 1; i <= count; i++) {
  rows.push(padRow(i, count));
}
...
/* COMMENTS TO TRY STUFF:

Console message should say...
...
// Step 19 // 7-07-24 starting point
  ...
  <body>
    <main>
      ...
      <section>
        <h2>Cat Form</h2>
        <form action="https://freecatphotoapp.com/submit-cat-photo">
          <label><input id="indoor" type="indoor-outdoor"> Indoor</label>
          <label><input id="outdoor" type="indoor-outdoor"> Outdoor</label>
          <input type="text" name="catphotourl" placeholder="cat photo URL" required>
          <button type="submit">Submit</button>
        </form>
      </section>
...
// Step 69 // Final Step of this project
...
// Next Challenge: Learn Basic CSS By Building A Cafe Menu //

// Step 1 // Tuesday July 9th 2024
...
// PAUSED ON FRIDAY JULY 12, 2024
// STEP 43 // CONTINUE ON SUNDAY JULY 14, 2024
// CSS //
body {
  width: 100%;
  height: 100vh;
...
// LEARN JAVASCRIPT BY BUILDING A BASIC ROLE-PLAYING GAME //
// Step 1 //
// HTML //
<!DOCTYPE html>
<html>
...
// Step 1: In your goTown function, change your button elements' innerText properties to be "Go to store", "Go to cave", and "Fight dragon" //
// Step 2: Update your onclick properties to be goStore, goCave, and fightDragon, respectively. //
// Step 3: Update innerText property of your text to be "You are in the town square. You see a sign that says Store." //
...
const locations = [
  {
    name: "town square",
    "button text": [button1.innerText, button2.innerText, button3.innerText]
  }
];
...
// Paused here at 1 p.m on Tuesday July 16th, 2024

// STARTING HERE ON WEDNESDAY JULY 17TH 2024

// Step 58 //
// Almost an 1 hour spent on this step because of not having a comma at end of the array property on the locations object //
// JS //
let xp = 0;
let health = 100;
let gold = 50;
...
// Continue progress on Wednesday July 17th 2024 //
// Step 68 // 1 hour to solve //
// JS //
...
// STOPPED HERE ON WEDNESDAY JULY 17TH 2024

// STARTED HERE ON FRIDAY JULY 18TH 2024
...
//STOPPED HERE ON FRIDAY JULY 19TH 2024

//CONT HERE ON FRIDAY JULY 19TH 2024
...
// STARTED HERE ON SUNDAY 21ST 2024 //
// Step 117 // Almost 2 hours to solve this problem.
// JS //
